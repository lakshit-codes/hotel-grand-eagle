...
const MEAL_PLANS = [
    ...
    { id: "mp_cp", code: "CP", name: "Continental Plan", description: "Room + complimentary breakfast", pricePerPersonPerNight: 1200 },
    { id: "mp_map", code: "MAP", name: "Modified American Plan", description: "Room + breakfast + dinner", pricePerPersonPerNight: 3500 },
    { id: "mp_ap", code: "AP", name: "Full American Plan", description: "Room + all meals (3x per day)", pricePerPersonPerNight: 5500 },
];
