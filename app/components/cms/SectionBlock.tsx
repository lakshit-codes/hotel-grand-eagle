...
import { cn } from "./blocks/CmsBlocks";
          ...
          <div className="flex flex-col flex-1 min-w-0">
            ...
            {isOpen ? (
              <Inp 
                ...
                style={{ height: 'auto', padding: 0, border: 'none', boxShadow: 'none' }}
              />
            ) : (
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 bg-white border border-slate-200 rounded-lg px-2">
            ...
            <Sel
              ...
              opts={[
                { v: "grid-1", l: "1 Column" },
                { v: "grid-2", l: "2 Columns" },
                { v: "grid-3", l: "3 Columns" },
                { v: "grid-4", l: "4 Columns" }
              ]}
              className="text-[10px] font-bold w-full"
              style={{ padding: "6px" , border: "none", boxShadow: "none" }}
             />
          </div>

          <button
            className="btn btn-ghost" style={{ color: "#f43f5e", padding: "6px", borderRadius: "10px" }}
            onClick={onRemove}
          >
            <Trash size={16} />
          </button>
